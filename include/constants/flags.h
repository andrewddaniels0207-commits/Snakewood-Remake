...
#define FLAG_HIDE_OLDALE_RIVAL_ALICIA                               0x493 // Snakewood: hide Alicia after player defeats her
#define FLAG_RECEIVED_BIRCH_EGG                                     0x494 // Snakewood: set when player receives egg from Birch on Route 103
...
#define FLAG_STARTER_CHOSEN             (SPECIAL_FLAGS_START + 0x57)
#define FLAG_HIDE_LITTLEROOT_BIRCHS_BAG (SPECIAL_FLAGS_START + 0x58)
