...
#define GRASS_STARTER (IS_FRLG ? SPECIES_BULBASAUR  : SPECIES_PARAS)
#define FIRE_STARTER  (IS_FRLG ? SPECIES_CHARMANDER : SPECIES_BALTOY)
#define WATER_STARTER (IS_FRLG ? SPECIES_SQUIRTLE   : SPECIES_KOFFING )
