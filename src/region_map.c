...
u32 FilterFlyDestination(struct RegionMap* regionMap)
{
    ...
    case MAPSEC_LITTLEROOT_TOWN:
        return (gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F : HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F);    case MAPSEC_EVER_GRANDE_CITY:
